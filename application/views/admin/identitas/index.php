                  ...
                  <tbody>
                    <?php foreach($identitas as $i) : ?>
                      <tr>
                        ...
                        <td><?= $i['telepon']; ?></td>
                        <td>
                          <button type="button" class="btn btn-info tombolUbahIdentitas" data-toggle="modal" data-target="#formIdentitasModal" data-id="<?= $i['id_identitas']; ?>"><i class="fa fa-edit"></i></button>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
